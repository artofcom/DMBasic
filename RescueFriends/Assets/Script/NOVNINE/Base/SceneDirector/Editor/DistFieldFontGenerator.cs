...
public class DistFieldFontGenerator : EditorWindow
{
    ...
    [MenuItem("NOVNINE/Font/Generate DistField Font")]
    ...
    {
		DistanceFont.IntFontInfo fntInfo = DistanceFont.ParseFromPath(path);
        ...
        foreach(DistanceFont.IntChar c in fntInfo.chars){
		...
		DistanceFont.SaveToXML(fntInfo, outputPath);
    }
}
