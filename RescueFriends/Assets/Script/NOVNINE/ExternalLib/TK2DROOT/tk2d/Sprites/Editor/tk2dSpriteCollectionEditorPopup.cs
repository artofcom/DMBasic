...
public interface IEditorHost
{
    ...
    SpriteCollectionProxy SpriteCollection {
        get;
    }
...
public class tk2dSpriteCollectionEditorPopup : EditorWindow, IEditorHost
{
    ...
    public SpriteCollectionProxy SpriteCollection
    {
        get {
    ...
    {
        get {
            return tk2dPreferences.inst.spriteCollectionInspectorWidth;
        }
    }
    ...
    void HandleListKeyboardShortcuts(int controlId)
    {
        ...
        if (ev.type == EventType.KeyDown
            ...
            case KeyCode.Home:
                ...
                break;
            case KeyCode.End:
                newSelectedIndex = entries.Count - 1;
                break;
            case KeyCode.UpArrow:
                newSelectedIndex = Mathf.Max(selectedIndex - 1, 0);
                break;
            case KeyCode.DownArrow:
                newSelectedIndex = Mathf.Min(selectedIndex + 1, entries.Count - 1);
                break;
            case KeyCode.PageUp:
                newSelectedIndex = Mathf.Max(selectedIndex - 10, 0);
                break;
            case KeyCode.PageDown:
                newSelectedIndex = Mathf.Min(selectedIndex + 10, entries.Count - 1);
                break;
            }
    ...
    {
        switch (kind) {
        case SpriteCollectionEditorEntry.Type.Sprite:
            return "Sprites";
        case SpriteCollectionEditorEntry.Type.SpriteSheet:
            return "Sprite Sheets";
        case SpriteCollectionEditorEntry.Type.Font:
            return "Fonts";
        }
    ...
    {
        get {
            return tk2dPreferences.inst.spriteCollectionListWidth;
        }
    }
