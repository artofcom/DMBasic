...
public class tk2dGrid
{
    ...
    void InitTexture()
    {
        if (gridTexture == null) {
            ...
            switch (gridType) {
            case Type.LightChecked:
                c0 = new Color32(255, 255, 255, 255);
                c1 = new Color32(217, 217, 217, 255);
                break;
            case Type.MediumChecked:
                c0 = new Color32(178, 178, 178, 255);
                c1 = new Color32(151, 151, 151, 255);
                break;
            case Type.DarkChecked:
                c0 = new Color32( 37,  37,  37, 255);
                c1 = new Color32( 31,  31,  31, 255);
                break;
            case Type.BlackChecked:
                c0 = new Color32( 14,  14,  14, 255);
                c1 = new Color32(  0,   0,   0, 255);
                break;
            case Type.LightSolid:
                c0 = new Color32(255, 255, 255, 255);
                c1 = c0;
                break;
            case Type.MediumSolid:
                c0 = new Color32(178, 178, 178, 255);
                c1 = c0;
                break;
            case Type.DarkSolid:
                ...
                c1 = c0;
                break;
            case Type.BlackSolid:
                c0 = new Color32(  0,   0,   0, 255);
                c1 = c0;
                break;
            case Type.Custom:
                c0 = tk2dPreferences.inst.customGridColor0;
                c1 = tk2dPreferences.inst.customGridColor1;
                break;
            }
