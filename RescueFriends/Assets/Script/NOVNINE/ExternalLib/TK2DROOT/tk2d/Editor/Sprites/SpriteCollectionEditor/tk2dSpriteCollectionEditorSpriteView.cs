...
public class SpriteView
{
    ...
    public void DrawSpriteEditorInspector(List<SpriteCollectionEditorEntry> entries, bool allowDelete, bool editingSpriteSheet)
    {
        ...
        if (newMeshType != meshType) {
            ...
            switch (newMeshType) {
            case CustomMeshType.Custom:
                param.customSpriteGeometry = true;
                break;
            case CustomMeshType.Diced:
                param.dice = true;
                break;
            case CustomMeshType.Default:
                break;
            case CustomMeshType.DoubleSided:
                param.doubleSidedSprite = true;
                break;
            }
    ...
    public void Draw(List<SpriteCollectionEditorEntry> entries)
    {
        ...
        if (entries == null || entries.Count == 0) {
            ...
            case SpriteCollectionEditorEntry.Type.Sprite:
                DrawSpriteEditorView(entries);
                break;
            case SpriteCollectionEditorEntry.Type.SpriteSheet:
                DrawSpriteSheetView(entries);
                break;
            }
        }
        GUILayout.EndVertical();
