...
public class AnimOperator
{
    ...
    public AnimEditOperations AnimEditOperations
    {
        get {
            return operations;
        }
    ...
    public virtual string[] AnimToolsMenu
    {
        get {
            return new string[0];
        }
    ...
    public virtual tk2dSpriteAnimationClip OnAnimMenu(string menuEntry, List<tk2dSpriteAnimationClip> allClips, tk2dSpriteAnimationClip selectedClip)
    {
        return selectedClip;
    }
    ...
    public virtual bool OnClipInspectorGUI(tk2dSpriteAnimationClip selectedClip, List<ClipEditor.FrameGroup> frameGroups, TimelineEditor.State state)
    {
        return false;
    }
...
{
    public override string[] AnimToolsMenu
    {
        get {
...
public class DeleteFrames : AnimOperator
{
    ...
    public override bool OnFrameGroupInspectorGUI(tk2dSpriteAnimationClip selectedClip, List<ClipEditor.FrameGroup> frameGroups, TimelineEditor.State state )
    {
        ...
        if (frameGroups.Count > 1) {
            ...
            GUILayout.BeginHorizontal();
            if (GUILayout.Button("Delete <", EditorStyles.miniButton)) {
                frameGroups.RemoveRange(0, state.selectedFrame);
                changed = true;
                state.selectedFrame = 0;
            }
            if (GUILayout.Button("Delete >", EditorStyles.miniButton)) {
                frameGroups.RemoveRange(state.selectedFrame + 1, frameGroups.Count - 1 - state.selectedFrame);
                changed = true;
