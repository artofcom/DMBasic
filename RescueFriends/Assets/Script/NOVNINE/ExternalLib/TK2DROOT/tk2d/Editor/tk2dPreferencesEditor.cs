...
public class tk2dPreferences
{
    ...
    {
        get {
            return _spriteCollectionListWidth;
        } set {
            if (_spriteCollectionListWidth != value) _spriteCollectionListWidth = value;
            Save();
        }
    }
    ...
    {
        get {
            return Mathf.Max(_spriteCollectionInspectorWidth, _minSpriteCollectionInspectorWidth);
        } set {
            if (_spriteCollectionInspectorWidth != value) _spriteCollectionInspectorWidth = value;
            Save();
        }
    }
    ...
    {
        get {
            return _animListWidth;
        } set {
            if (_animListWidth != value) _animListWidth = value;
            Save();
        }
    }
    ...
    {
        get {
            return Mathf.Max(_animInspectorWidth, _minSpriteCollectionInspectorWidth);
        } set {
            if (_animInspectorWidth != value) _animInspectorWidth = value;
            Save();
        }
    }
    ...
    {
        get {
            return _animFrameWidth;
        } set {
            if (_animFrameWidth != value) _animFrameWidth = value;
            Save();
        }
    }
    ...
    {
        get {
            return _spriteThumbnailSize;
        } set {
            if (_spriteThumbnailSize != value) _spriteThumbnailSize = value;
            Save();
        }
    }
