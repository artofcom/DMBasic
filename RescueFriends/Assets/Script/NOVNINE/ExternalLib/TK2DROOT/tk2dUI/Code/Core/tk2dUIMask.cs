...
public class tk2dUIMask : MonoBehaviour
{
    ...
    public bool useExternalMesh     = false;

    bool _useExternalMeshFilter     = false;
    ...
    void OnDestroy()
    {
        if(useExternalMesh && _useExternalMeshFilter)
            return;
    ...
    public void Build()
    {
        if (ThisMeshFilter.sharedMesh == null) {
            ...
            if(true == useExternalMesh)
                _useExternalMeshFilter  = true; // 2 중 flag.. 음...
            else
