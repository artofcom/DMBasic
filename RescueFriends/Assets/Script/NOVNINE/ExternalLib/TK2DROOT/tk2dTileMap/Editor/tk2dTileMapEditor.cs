...
public class tk2dTileMapEditor : Editor, ITileMapEditorHost
{
    ...
    tk2dEditor.BrushRenderer brushRenderer
    {
        get {
            ...
            if (value != null) {
                Debug.LogError("Only alloyed to set to null");
                return;
            }
    ...
    tk2dEditor.BrushBuilder guiBrushBuilder
    {
        get {
            ...
            if (value != null) {
                Debug.LogError("Only allowed to set to null");
                return;
            }
    ...
    void DrawPaintPanel()
    {
        ...
        if (tileMap.data.NumLayers > 1) {
            GUILayout.BeginVertical();
            GUILayout.BeginHorizontal(EditorStyles.toolbar, GUILayout.ExpandWidth(true));
            GUILayout.Label("Layers", EditorStyles.toolbarButton);
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (editorData == null || tileMap.data == null || tileMap.Editor__SpriteCollection == null || !tileMap.AreSpritesInitialized()) {
            ...
            case tk2dTileMapEditorData.EditMode.Color:
                DrawColorPaintPanel();
                break;
            case tk2dTileMapEditorData.EditMode.Settings:
                DrawSettingsPanel();
                break;
            case tk2dTileMapEditorData.EditMode.Data:
                DrawTileDataSetupPanel();
                break;
            }
        }
    }
