...
public static class OBBDownloader
{
    //private static string PublicKey = LCommonDefine.GOOGLESTORKEY;
...
//	}
	...
	static OBBDownloader()
	{
        ...
        using (AndroidJavaClass downloaderServiceClass = new AndroidJavaClass("nov9.downloader.UnityDownloaderService"))
		{
            downloaderServiceClass.SetStatic("BASE64_PUBLIC_KEY", LCommonDefine.GOOGLESTORKEY);
            //downloaderServiceClass.SetStatic("GAME_OBJECT", "__Splash__");
    ...
    public static void SetOBBMessageGameObjectName(string _name)
    {
        ...
        using (AndroidJavaClass downloaderServiceClass = new AndroidJavaClass("nov9.downloader.UnityDownloaderService"))
        {
            downloaderServiceClass.SetStatic("RECEIVER_NAME", _name);
        }
    }
	...
	public static void FetchOBB()
	{
		using (AndroidJavaClass unityPlayerClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
		{
			...
			AndroidJavaObject intent = new AndroidJavaObject("android.content.Intent",currentActivity, new AndroidJavaClass("nov9.downloader.UnityDownloaderActivity"));
			...
			{
				Debug.Log("Exception occurred while attempting to start DownloaderActivity - is the AndroidManifest.xml incorrect?\n" + e.Message);
			}
		}
	}
